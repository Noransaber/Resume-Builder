    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <TableOfContents sections={['Introduction', 'Definitions', 'User Responsibilities', 'Intellectual Property Rights', 'Disclaimers', 'Limitation of Liability', 'Governing Law', 'Changes to These Terms', 'Contact Information']} />
          <div className="mt-8">
